...
public class MainFragment_Hot extends Fragment
{
	...
	private View initTabHost(LayoutInflater inflater, Bundle savedInstanceState) {
		...
		View view1=getActivity().getLayoutInflater().inflate(R.layout.item_hotdetali_tab1, null);
		TabSpec setIndicator1 = mTabHost.newTabSpec("jingxuan").setIndicator(view1);
		mTabsAdapter.addTab(
				setIndicator1,
				Frame_hot1.class, null);
		View view2=getActivity().getLayoutInflater().inflate(R.layout.item_hotdetali_tab2, null);
		
		TabSpec setIndicator2 = mTabHost.newTabSpec("allfourm")
				.setIndicator(view2);
		mTabsAdapter.addTab(setIndicator2, Frame_hot2.class, null);
		View view3=getActivity().getLayoutInflater().inflate(R.layout.item_hotdetali_tab3, null);
		TabSpec setIndicator3 = mTabHost.newTabSpec("allfourm")
				.setIndicator(view3);
		mTabsAdapter.addTab(setIndicator3, Frame_hot1.class, null);
		View view4=getActivity().getLayoutInflater().inflate(R.layout.item_hotdetali_tab4, null);
		TabSpec setIndicator4 = mTabHost.newTabSpec("allfourm")
				.setIndicator(view4);
		mTabsAdapter.addTab(setIndicator4, Frame_hot2.class, null);
