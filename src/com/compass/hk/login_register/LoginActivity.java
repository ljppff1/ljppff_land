...
public class LoginActivity extends FragmentActivity implements OnClickListener {
	...
	private void summit() {
        ...
        if ("".equals(email)||email==null) {
  		  new CustomerAlertDialog(LoginActivity.this, "請輸入您的註冊郵箱").show();
  		}    
        else {
     	   if (isEmail(email)) {
				
     		   if ("".equals(pwd)||email==null) {
     			   new CustomerAlertDialog(LoginActivity.this, "請輸入密碼").show();
     		   }
     		   else {
     			   updown(email,pwd);
     		   }
     		   ...
     		   new CustomerAlertDialog(LoginActivity.this, "郵箱地址不正確").show(); 
			}
		}
}
							...
							JSONObject result =new JSONObject(responseInfo.result);
							 JSONObject detail = result.getJSONObject("data");
							  ...
							  if ("1".equals(code)) {
								  ...
								  Toast.makeText(LoginActivity.this, "成功登錄", Toast.LENGTH_SHORT).show();
